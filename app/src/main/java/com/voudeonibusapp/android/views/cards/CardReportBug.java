    ...
    private void setClickListener() {
        this.reportBugButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("mailto:falecom@voudeonibusapp.com?subject=Encontrei%20um%20erro&amp;body=Oi%2C%20eu%20encontrei%20um%20erro%3A%0A%0ANa%20tela%20de%3A%0AEle%20aconteceu%20quando%3A`"));
