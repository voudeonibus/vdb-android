...
import com.voudeonibus.api.LineAPI;
...
import com.voudeonibus.utils.JSONUtils;
            ...
            public void exec(int statusCode, JSONArray response) {
                ...
                try {
                    ...
                    for (int i = 0; i < lenght; i++) {
                        ...
                        realm.createObjectFromJson(com.voudeonibus.models.api.Line.class, object.toString());
